        ...
        @if(Auth::user()->status == 'Ativo')
            ...
            <li>
                ...
                <a href="#adminSubmenu" data-toggle="collapse"
                   aria-expanded=@if(Request::path() == 'ommanager' || Request::path() == 'admin/usermanager') "true" @else
                    "false" @endif
                class="link-menu__sidebar dropdown-toggle
                adjust-caret_sidebar @if(Request::path() == 'ommanager' || Request::path() == 'admin/usermanager')
                ...
                <ul class=" @if(Request::path() == 'ommanager' || Request::path() == 'reportsmanager' || Request::path() == 'admin/usermanager') show @else collapse @endif list-unstyled"
                    ...
                    <li>
                        <a href="{{ route("usermanager.index") }}"
                           class="link-menu__sidebar link-submenu__sidebar @if (Request::path() == 'admin/usermanager') active__sublink @endif"><i
                                class="fas fa-user"></i> Controle de Usuários</a>
                    </li>
                    <li>
                        <a href="{{ route("ommanager.index") }}"
